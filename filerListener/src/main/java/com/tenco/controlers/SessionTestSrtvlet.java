...
public class SessionTestSrtvlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SessionTestSrtvlet() {
        super();
    }
	...
	// 새로운 세션을 생성해 보자.
		...
		response.getWriter().print("당신에 세션 아디는 : "+ session.getId());
	...
	if(session != null) {
		...
		// sendRedorect --> 클라이언트로 돌아감 (브라우저로 돌아 감)
